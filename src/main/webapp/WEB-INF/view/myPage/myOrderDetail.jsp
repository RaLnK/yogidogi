	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 mb-10 mb-md-0">
				<h2 class="h3 mb-3 text-black" style="text-align: center">주문 상세
					내역</h2>

				<h4 class="h5 text-black">
					주문자 정보
					</h2>
					<div class="p-3 p-lg-5 col-md-12 border bg-white">
						<div class="form-group row" style="padding: 1rem;">
							<div class="col-md-4" style="text-align: center;">
								<strong class="text-black" style="line-height: 50px;">주문
									번호 :</strong>
							</div>
							<div class="col-md-8">
						...
						<div class="form-group row" style="padding: 1rem;">
							<div class="col-md-4" style="text-align: center;">
								<strong class="text-black" style="line-height: 50px;">이름
									:</strong>
							</div>
							<div class="col-md-8">
						...
						<div class="form-group row" style="padding: 1rem;">
							<div class="col-md-4" style="text-align: center;">
								<strong class="text-black" style="line-height: 50px;">수신지
									주소 :</strong>
							</div>
							<div class="col-md-8">
								<h6 class="text-black" style="line-height: 50px;">${orderVO.orderAddr }
									${orderVO.orderAddr2 }</h6>
							</div>
						</div>

						<div class="form-group row" style="padding: 1rem;">
							<div class="col-md-4" style="text-align: center;">
								<strong class="text-black" style="line-height: 50px;">전화번호
									:</strong>
							</div>
							<div class="col-md-8">
									...
									<table class="table">
										<thead>
											...
											<tr>
												...
												<div id='reviewBtn'>
													<button type="button" class="rmodal" data-toggle="modal"
														data-target="#form">리뷰쓰기</button>
														...
														<div class="modal-dialog modal-dialog-centered"
															...
															<div class="modal-content">
																<div class="text-right cross">
																	<i class="fa fa-times mr-2 exit"></i>
																</div>
																<h4>리뷰를 작성해주세요!</h4>
																<div class="card-body text-center">
																	<img
																		src="https://cdn-icons-png.flaticon.com/512/5783/5783307.png"
																	...
																	<div class="comment-box text-center">
																		...
																		<input class="form-control myImg" type="file"
																			name="myImg">
																		<div class="comment-area">
																			<textarea class="form-control reviewContent"
																				placeholder="해당 상품은 어떠셨나요?" rows="4"></textarea>
																		</div>
																		<div class="text-center mt-4">
																			<button class="send px-5">
																				리뷰 등록<i class="fa fa-long-arrow-right ml-1"></i>
																			</button>
																		</div>
																	</div>
																</div>
								...
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-12 text-right border-bottom">
											<h3 class="text-black h5" style="text-align: center">결제
												정보</h3>
										</div>
									</div>
									<div class="row mb-3">
								...
								<div class="row">
									<div class="col-md-12" style="text-align: right">
										<button class="btn"
											...
											id="backToShop">Shop</button>
										<button class="btn"
											style="color: white; background-color: black;"
											id="backToList">주문 목록</button>
									</div>
								</div>
							</div>
						</div>
...
<script>
	let ono = '${requestScope.orderVO.orderNo}'
</script>
