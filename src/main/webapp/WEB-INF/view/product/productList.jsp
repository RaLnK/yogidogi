...
<div id="sort">
	<p>
		<a href="#" class="btn btn-outline-success active" id ="news">신상품</a>
		<a href="#" class="btn btn-outline-success" id ="sales">판매순</a>
		<a href="#" class="btn btn-outline-success" id ="discount">할인률순</a> 
	</p>
</div>
